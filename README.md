...
oneview_server_profile_template 'ServerProfileTemplate1' do
  ...
  server_profile_name <profile_name>  # String - Optional. Used in create/create_if_missing actions. It is the name of the Server Profile be used as base for the Server Profile Template. Only available on API500 and onwards to be used as base.
