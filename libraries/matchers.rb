...
if defined?(ChefSpec)
  ...
  oneview_resources = {
    ...
    oneview_ethernet_network:           standard_actions + scope_actions + %i[reset_connection_template bulk_delete],
    oneview_event:                      [:create],
    oneview_fabric:                     [:set_reserved_vlan_range],
    oneview_fc_network:                 standard_actions + scope_actions + %i[reset_connection_template bulk_delete],
    oneview_fcoe_network:               standard_actions + scope_actions + %i[reset_connection_template bulk_delete],
