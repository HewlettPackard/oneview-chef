...
if defined?(ChefSpec)
  ...
  oneview_resources = {
    ...
    oneview_fc_network:                 standard_actions + scope_actions + %i[reset_connection_template delete_bulk],
    oneview_fcoe_network:               standard_actions + scope_actions + %i[reset_connection_template delete_bulk],
    oneview_firmware:                   %i[add remove create_custom_spp],
    oneview_hypervisor_manager:         standard_actions + %i[update_registration],
    oneview_hypervisor_cluster_profile: standard_actions + %i[update],
    ...
    oneview_logical_interconnect:       %i[none add_interconnect remove_interconnect update_internal_networks update_settings
                                           ...
                                           activate_firmware update_from_group reapply_configuration bulk_inconsistency_validate] + scope_actions,
