...
if defined?(ChefSpec)
  ...
  action_list = %w(create add delete remove set reset refresh update configure reconfigure edit none discover)
  ...
  oneview_resources = {
    ...
    oneview_server_profile:             standard_actions + [:create_snapshot_if_missing, :delete_snapshot],
