# (c) Copyright 2010 Hewlett Packard Enterprise Development LP
#
  ...
  module ImageStreamer
    ...
    module API2010
      ...
      def self.provider_named(type, _variant = nil)
        ...
        constants.each do |c|
          klass = OneviewCookbook::ImageStreamer::API2010.const_get(c)
        ...
        raise "The '#{type}' resource does not exist for Image Streamer API version 2010."
      end
    end
  end
end
