  ...
  module ImageStreamer
    ...
    module API2020
      ...
      def self.provider_named(type, _variant = nil)
        ...
        constants.each do |c|
          klass = OneviewCookbook::ImageStreamer::API2020.const_get(c)
        ...
        raise "The '#{type}' resource does not exist for Image Streamer API version 2020."
      end
    end
  end
end
