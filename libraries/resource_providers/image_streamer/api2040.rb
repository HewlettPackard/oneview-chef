...
require_relative 'api2020'

module OneviewCookbook
  module ImageStreamer
    # Module for Image Streamer API 2040 Resources
    module API2040
      ...
      def self.provider_named(type, _variant = nil)
        ...
        constants.each do |c|
          klass = OneviewCookbook::ImageStreamer::API2040.const_get(c)
        ...
        raise "The '#{type}' resource does not exist for Image Streamer API version 2040."
      end
    end
  end
end
...
Dir[File.dirname(__FILE__) + '/api2040/*.rb'].each { |file| require file }
