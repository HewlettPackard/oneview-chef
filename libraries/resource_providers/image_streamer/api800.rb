  ...
  module ImageStreamer
    ...
    module API800
      ...
      def self.provider_named(type, _variant = nil)
        ...
        constants.each do |c|
          klass = OneviewCookbook::ImageStreamer::API800.const_get(c)
        ...
        raise "The '#{type}' resource does not exist for Image Streamer API version 800."
      end
    end
  end
end
