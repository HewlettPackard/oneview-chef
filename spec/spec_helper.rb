...
RSpec.configure do |config|
  ...
  config.before(:each) do
    ...
    allow_any_instance_of(OneviewSDK::Client).to receive(:appliance_api_version).and_return(3200)
...
RSpec.shared_context 'chef context', a: :b do
  ...
  let(:client800) do
    OneviewSDK::Client.new(url: 'https://oneview.example.com', user: 'Administrator', password: 'secret123', api_version: 800)
  end

  let(:client1000) do
    OneviewSDK::Client.new(url: 'https://oneview.example.com', user: 'Administrator', password: 'secret123', api_version: 1000)
  end
  ...
  let(:client1800) do
    OneviewSDK::Client.new(url: 'https://oneview.example.com', user: 'Administrator', password: 'secret123', api_version: 1800)
  end

  let(:client2000) do
    OneviewSDK::Client.new(url: 'https://oneview.example.com', user: 'Administrator', password: 'secret123', api_version: 2000)
  end

  let(:client2200) do
    OneviewSDK::Client.new(url: 'https://oneview.example.com', user: 'Administrator', password: 'secret123', api_version: 2200)
  end

  let(:client2400) do
    OneviewSDK::Client.new(url: 'https://oneview.example.com', user: 'Administrator', password: 'secret123', api_version: 2400)
  end

  let(:client2600) do
    OneviewSDK::Client.new(url: 'https://oneview.example.com', user: 'Administrator', password: 'secret123', api_version: 2600)
  end

  let(:client2800) do
    OneviewSDK::Client.new(url: 'https://oneview.example.com', user: 'Administrator', password: 'secret123', api_version: 2800)
  end

  let(:client3000) do
    OneviewSDK::Client.new(url: 'https://oneview.example.com', user: 'Administrator', password: 'secret123', api_version: 3000)
  end
  ...
  let(:i3s_client2000) do
    OneviewSDK::ImageStreamer::Client.new(url: 'https://i3s.example.com', token: 'token123', api_version: 2000)
  end

  let(:i3s_client2010) do
    OneviewSDK::ImageStreamer::Client.new(url: 'https://i3s.example.com', token: 'token123', api_version: 2010)
  end

  let(:i3s_client2020) do
    OneviewSDK::ImageStreamer::Client.new(url: 'https://i3s.example.com', token: 'token123', api_version: 2020)
  end

  let(:i3s_client2040) do
    OneviewSDK::ImageStreamer::Client.new(url: 'https://i3s.example.com', token: 'token123', api_version: 2040)
  end
end
