...
describe 'oneview_test::logical_enclosure_reconfigure' do
  ...
  before :each do
    ...
    allow(OneviewSDK::Enclosure).to receive(:find_by)
      .with(instance_of(OneviewSDK::Client), { 'uri' => '/rest/enclosures/encl1' }, OneviewSDK::Enclosure::BASE_URI, {})
      .and_return([encl1])
    allow(OneviewSDK::Enclosure).to receive(:find_by)
      .with(instance_of(OneviewSDK::Client), { 'uri' => '/rest/enclosures/encl2' }, OneviewSDK::Enclosure::BASE_URI, {})
      .and_return([encl2])
  end
