...
describe 'oneview_test::default' do
  ...
  it 'supports all oneview matchers' do
    ...
    expect(chef_run).to_not delete_bulk_oneview_fc_network('')
    ...
    expect(chef_run).to_not delete_bulk_oneview_fcoe_network('')
    ...
    expect(chef_run).to_not update_oneview_logical_interconnect_port_flap_settings('')
