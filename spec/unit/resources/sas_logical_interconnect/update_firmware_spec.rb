...
describe 'oneview_test_api300_synergy::sas_logical_interconnect_update_firmware' do
  ...
  it 'updates the current firmware' do
    ...
    expect(real_chef_run).to update_oneview_sas_logical_interconnect_firmware('SASLogicalInterconnect-update_firmware')
  end
end
