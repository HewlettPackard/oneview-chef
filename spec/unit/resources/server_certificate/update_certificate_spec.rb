...
describe 'oneview_test_api600_c7000::server_certificate_update_certificate' do
  ...
  it 'adds it when it does not exist' do
    expect_any_instance_of(OneviewSDK::API600::C7000::ServerCertificate).to receive(:retrieve!).and_return(true)
    expect_any_instance_of(OneviewSDK::API600::C7000::ServerCertificate).to receive(:get_certificate).and_return(expected_certificate)
    expect_any_instance_of(OneviewSDK::API600::C7000::ServerCertificate).to receive(:update).and_return(true)
