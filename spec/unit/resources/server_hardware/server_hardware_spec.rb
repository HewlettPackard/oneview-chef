...
describe 'oneview_test::server_hardware_patch' do
  ...
  it 'performs patch operation' do
    ...
    expect_any_instance_of(OneviewSDK::ServerHardware).to receive(:patch).with('test', 'test/', 'TestMessage').and_return(true)
